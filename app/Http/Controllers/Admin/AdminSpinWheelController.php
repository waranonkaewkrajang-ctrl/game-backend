...
class AdminSpinWheelController extends Controller
{
    ...
    public function storePrize(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'img_scale'   => 'nullable|integer|min:30|max:300',
            'img_x'       => 'nullable|integer|min:-60|max:60',
            'img_y'       => 'nullable|integer|min:-60|max:60',
            'img_rotate'  => 'nullable|integer|min:-180|max:180',
